...
, show_debug_info_(false)
{
   ...
   this->scene_graph_[1] = new SceneGraphNode(this->camera_); // layer for map
   this->scene_graph_[2] = new SceneGraphNode(this->camera_); // layer for rectangle selection
   this->scene_graph_[3] = new SceneGraphNode(this->camera_); // layer for hud
   this->scene_graph_[4] = new SceneGraphNode(this->camera_); // layer for mouse
   ...
   this->scene_graph_[1]->add(new SceneGraphNode(this->map_));
   ...
   this->scene_graph_[4]->add(new SceneGraphNode(this->mouse_));
   ...
   this->scene_graph_[3]->add(new SceneGraphNode(t));
   ...
   this->scene_graph_[3]->add(new SceneGraphNode(this->center_dot_));
   ...
   this->scene_graph_[3]->add(new SceneGraphNode(this->fps_display_));
}
